...
GtkWidget* create_icon_size_line(GtkWidget *window, gint mode);
GtkWidget* create_transparency_line(GtkWidget *window, gint mode);
GtkWidget* create_background_color_button(GtkWidget *window, gint mode);
GtkWidget* create_visible_items_line(GtkWidget *window, gint mode);
