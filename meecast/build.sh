...
'_save_station_js', '_currentstationname_js', '_download_forecasts', '_convert_forecasts', \
'_convert_station_gismeteo_data', 'convert_station_gismeteo_data', '_start_convert_function', \
'_run_convert_js']"  --minify 0  -O2 --closure 0  ../core/libxml2/.libs/libxml2.a \
                                       ...
                                       ../core/.libs/libmeecast_core_la-visible.o \
