...
GHashTable* hash_table_create(void){
    ...
    g_hash_table_insert(hash, "Drifting Snow", _("Drifting Snow"));
    ...
    g_hash_table_insert(hash, "Few Snow Showers / Wind", _("Few Snow Showers / Wind"));    
    ...
    g_hash_table_insert(hash, "PM Rain / Snow", _("PM Rain / Snow"));    
    ...
    g_hash_table_insert(hash, "Snow Showers / Wind Early", _("Snow Showers / Wind Early"));
    g_hash_table_insert(hash, "Snow Showers Early", _("Snow Showers Early"));
    ...
    g_hash_table_insert(hash, "T-Showers", _("T-Showers"));    
