...
DBusHandlerResult get_mce_signal_cb_popup(DBusConnection *conn, DBusMessage *msg, gpointer data);
void set_portrait(GtkWidget *self, char const *prop, guint32 value);
/*******************************************************************************/
#endif
