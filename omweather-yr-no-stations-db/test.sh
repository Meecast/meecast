#!/bin/bash
valgrind --tool=memcheck --log-file=1.log -v --track-origins=yes  --leak-check=full --show-reachable=yes ./yrno "examples/yr.no_Belarus#Vitsyebsk#Vitebsk.orig" ./out.xml
