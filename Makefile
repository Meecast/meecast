...
clean:
	...
	$(MAKE) -C ./arm/openweathermap -f Makefile sureclean
	...
	$(MAKE) -C ./x86/openweathermap -f Makefile sureclean	
...
Makefile: FORCE	
	...
	$(QMAKE) -spec unsupported/blackberry-armv7le-qcc -o arm/openweathermap/Makefile omweather-openweathermap-org-stations-db/omweather-openweathermap-org-stations-db.pro CONFIG+=device
	...
	$(QMAKE) -spec unsupported/blackberry-x86-qcc -o x86/openweathermap/Makefile omweather-openweathermap-org-stations-db/omweather-openweathermap-org-stations-db.pro CONFIG+=simulator
...
device:
	...
	$(MAKE) -C ./arm/openweathermap -f Makefile all
...
Device-Debug: Makefile
	...
	$(MAKE) -C ./arm/openweathermap -f Makefile debug 
...
Device-Release: Makefile
	...
	$(MAKE) -C ./arm/openweathermap -f Makefile release 
...
simulator:
	...
	$(MAKE) -C ./x86/openweathermap -f Makefile all 
...
Simulator-Debug: Makefile
	...
	$(MAKE) -C ./x86/openweathermap -f Makefile debug
