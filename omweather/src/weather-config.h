...
#define GCONF_KEY_HIDE_WIND			GCONF_KEY_PREFIX"/hide-wind"
#define GCONF_KEY_HIDE_STATION_NAME		GCONF_KEY_PREFIX"/hide-station-name"
#define GCONF_KEY_HIDE_ARROWS			GCONF_KEY_PREFIX"/hide-arrows"
...
#define GCONF_KEY_WEATHER_DATA_SOURCE		GCONF_KEY_PREFIX"/data-source"
