 ...
 * 02110-1301 USA
*/
#ifndef _MEECAST_DYNAMIC_MESSAGE_PORT_H_
#define _MEECAST_DYNAMIC_MESSAGE_PORT_H_
...
class MeecastDynamicMessagePort
	: public Tizen::Io::IMessagePortListener
{
public :
	MeecastDynamicMessagePort(void);
...
#endif // _MEECAST_DYNAMIC_MESSAGE_PORT_H_
